...
class Phillippines_Regulatory_Updates(scrapy.Spider):
    ...
    name = 'phillippines_regulatory_updates'
    ...
    data_keywords = [ 'regulat', 'law', 'policy', 'complianc', 'standard', 'guideline', 'rule', 'mandate', 'control', 'requirement', 'licens', 'authorization', 'insurance']
